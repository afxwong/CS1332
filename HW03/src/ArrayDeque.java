...
public class ArrayDeque<T> {
    ...
    public void addFirst(T data) {
        ...
        if (this.size == this.backingArray.length) {
            ...
            newarray[0] = data;
            int backingarrayptr = this.front;
            int newarrayptr = 1;
            do {
                newarray[newarrayptr] = this.backingArray[backingarrayptr];
                newarrayptr++;
                backingarrayptr = mod(backingarrayptr + 1, this.backingArray.length);
            } while (backingarrayptr != this.front);
            this.backingArray = newarray;
            this.front = 0;
        } else {
            int ptr = mod(this.front - 1, backingArray.length);
            this.backingArray[ptr] = data;
            this.front = ptr;
        }
        this.size++;
    }
    ...
    public void addLast(T data) {
        ...
        if (this.size == this.backingArray.length) {
            ...
            newarray[newarrayptr] = data;
            this.backingArray = newarray;
            this.front = 0;
        } else {
            int ptr = mod(this.front + this.size, this.backingArray.length);
            this.backingArray[ptr] = data;
        }
        this.size++;
    }
    ...
    public T removeLast() {
        ...
        int ptr = mod(this.front + this.size - 1, this.backingArray.length);
        T data = this.backingArray[ptr];
        this.backingArray[ptr] = null;
        this.size--;
        return data;
    }
